...
public class nonvolunteer extends AppCompatActivity {
    ...
    private void UPI_trans(){
        ...
        easyUpiPayment.setPaymentStatusListener(new PaymentStatusListener() {
            ...
            public void onTransactionSuccess() {
                ...
                Toast.makeText(nonvolunteer.this, "Successful", Toast.LENGTH_SHORT).show();
                Mail();
            }
            ...
            public void onTransactionSubmitted() {
                // Payment Pending
                Toast.makeText(nonvolunteer.this, "Pending | Submitted", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onTransactionFailed() {
                // Payment Failed
                Toast.makeText(nonvolunteer.this, "Failed", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onTransactionCancelled() {
                // Payment Cancelled by User
                Toast.makeText(nonvolunteer.this, "Cancelled", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onAppNotFound() {
                Toast.makeText(nonvolunteer.this, "No App Found", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            cb.document().set(info).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(nonvolunteer.this, "User Registered into Database", Toast.LENGTH_SHORT).show();

                    } else {
                        Toast.makeText(nonvolunteer.this, "Registration failed.", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    public void onBackPressed() {
        Intent i = new Intent(nonvolunteer.this, Boommain.class);
        startActivity(i);
        finish();
    }
}
